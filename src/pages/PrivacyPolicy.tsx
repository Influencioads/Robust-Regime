        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          ...
          <div className="prose prose-lg max-w-none">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              ...
              <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Robust Regime, Asherestate,Varun 3,7Upnagar, Nashik -Pune Rd,Nashik,maharashtra,422101.</li>
              ...
              <li><strong>Website</strong> refers to robust regime, accessible from https://robustregime.com/</li>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Tracking Technologies and Cookies</h3>
            <p className="mb-4">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-3">
              <li>
                ...
                <span className="text-sm text-gray-600">Type: Session Cookies</span><br />
                <span className="text-sm text-gray-600">Administered by: Us</span><br />
                <span className="text-sm text-gray-600">Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</span>
              </li>
              <li>
                <strong>Cookies Policy / Notice Acceptance Cookies</strong><br />
                <span className="text-sm text-gray-600">Type: Persistent Cookies</span><br />
                <span className="text-sm text-gray-600">Administered by: Us</span><br />
                <span className="text-sm text-gray-600">Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</span>
              </li>
              <li>
                <strong>Functionality Cookies</strong><br />
                <span className="text-sm text-gray-600">Type: Persistent Cookies</span><br />
                <span className="text-sm text-gray-600">Administered by: Us</span><br />
                <span className="text-sm text-gray-600">Purpose: These Cookies allow us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time You use the Website.</span>
              </li>
            </ul>
            ...
            <h3 className="text-xl font-semibold text-gray-800 mt-6 mb-3">Links to Other Websites</h3>
            <p className="mb-4">
            ...
            <ul className="list-disc pl-6 mb-6 space-y-2">
              <li>By email: <a href="mailto:salesteam@robustregime.com" className="text-[#fe6302] hover:underline">salesteam@robustregime.com</a></li>
              <li>By phone number: <a href="tel:+918446689098" className="text-[#fe6302] hover:underline">+91 8446689098</a></li>
            </ul>
          </div>
        </div>
      </div>
